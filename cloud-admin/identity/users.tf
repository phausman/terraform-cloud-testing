...
resource "openstack_identity_role_assignment_v3" "role-asignment_admin-in-test-domain" {
...
resource "openstack_identity_role_assignment_v3" "role-assignment_admin-in-test-admin-project" {
    user_id = "${openstack_identity_user_v3.domain-admin.id}"
